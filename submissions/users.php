...
if(isset($_POST['reset_passsword'])) {
  ...
  $user = mysqli_query($conn, $q)->fetch_assoc();

  if(!empty($user)) {
    echo "<a href='http://localhost/new/resetPassword.php?id=".$user['id']."'>Reset your password here</a>";
    die();
  } else {
...
if(isset($_POST['new_password'])) {
  ...
  if($password != $cpassword) {
    $_SESSION['error'] = "Both passwords didn't match";
  ...
  if(mysqli_query($conn, $q)) {
    $_SESSION['response'] = array(
      'type' => 'success',
      'msg' => "Password has been changed!. You can login now."
    );
    header("Location: ../login.php");
    die();
  } else {
